...
import { getAllTweets, getIsActive, getRefresh } from '../redux/tweetsSlice';
...
const CreatePost = () => {
  ...
  return (
    <div className='w-[100%]'>
      <div>
      <div 
      className='flex icons-center justify-evenly border-b border-gray-200 '>
            <div
             onClick={forYouHandler}
             className={`${isActive ? "border-b-4 border-blue-600" : "border-b-4 border-transparent"} cursor-pointer hover:bg-gray-200 w-full text-center px-4 py-3`}>
